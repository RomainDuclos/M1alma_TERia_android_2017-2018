...
public class MathsTest {
    ...
    public void pow_isCorrect() throws Exception {
       ...
       /* a.set(3.0,4.0);
        ...
        b.set(-2.0,-2.0);
        r = IMaths.my_pow(a,b);
        assertEquals(0.11111111111111109,r.lo,0.0);
    ...
    @Test
    public void pown_isCorrect() throws Exception {
    ...
    public void exp_isCorrect() throws Exception {
        ...
        a.set(1.0,1.0);
        r = IMaths.exp(a);
        assertEquals(2.7182818284590452,r.lo,0.0);
        assertEquals(2.7182818284590452,r.hi,0.0);
        ...
        a.set(-10.0,-5.0);
        r = IMaths.exp(a);
        assertEquals(4.5399929762484854e-5,r.lo,0.0);
        assertEquals(6.737946999085467e-3,r.hi,0.0);

        //TEST_EQ(exp(interval(-5.0,9.0)),interval("[6.7379469990854e-3,8103.0839275754]"));
        a.set(-5.0,9.0);
        r = IMaths.exp(a);
        assertEquals(6.737946999085467e-3,r.lo,0.0);
        assertEquals(8103.083927575384,r.hi,0.0);

        //TEST_EQ(exp(interval(9.0,11.0)),interval("[8103.0839275754,59874.14171519782]"));
        a.set(9.0,11.0);
        r = IMaths.exp(a);
        assertEquals(8103.083927575384,r.lo,0.0);
        assertEquals(59874.14171519782,r.hi,0.0);

        //TEST_EQ(exp(interval(-3.5)),interval("3.01973834223185e-2"));
        a.set(-3.5,-3.5);
        r = IMaths.exp(a);
        assertEquals(3.01973834223185e-2,r.lo,0.0);
        assertEquals(3.01973834223185e-2,r.hi,0.0);

        //TEST_EQ(exp(interval(3.5)),interval("33.1154519586923"));
        a.set(3.5,3.5);
        r = IMaths.exp(a);
        assertEquals(33.11545195869231,r.lo,0.0);
        assertEquals(33.11545195869231,r.hi,0.0);
    ...
    public void log_isCorrect() throws Exception {
        ...
        r = IMaths.log(a);
        assertEquals(Double.NEGATIVE_INFINITY,r.lo,0.0);
        assert((a.hi-1.386294361119891)<=1e-8);

        //TEST_EQ(log(interval(5,9)),interval(1.6094379124341003746,2.19722457733621938279));
        a.set(5.0,9.0);
        r = IMaths.log(a);
        assertEquals(1.6094379124341003746,r.lo,0.0);
        assertEquals(2.19722457733621938279,r.hi,0.0);

        //TEST_EQ(log(interval("56.1")),interval("4.02713581252865063169"));
        a.set(56.1,56.1);
        r = IMaths.log(a);
        //assertEquals(4.02713581252865063169,r.lo,0.0); //-> arrondi cassé ...
        assertEquals(4.02713581252865063169,r.hi,0.0);
    ...
    public void tan_isCorrect() throws Exception {
        ...
        a.set(0.0,1.0);
        r = IMaths.tan(a);
        //assertEquals(0.0,r.lo,0.0); //arrondi cassé
        assertEquals(1.55740772465490223051,r.hi,0.0);

	    //TEST_EQ(tan(interval(-1,0)),interval(-1.55740772465490223051,0));
        a.set(-1.0,0.0);
        r = IMaths.tan(a);
        assertEquals(-1.55740772465490223051,r.lo,0.0);
        assertEquals(0.0,r.hi,0.0);
